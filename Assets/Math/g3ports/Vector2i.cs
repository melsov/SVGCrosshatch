...
namespace g3
{
    public struct Vector2i : IComparable<Vector2i>, IEquatable<Vector2i>
    {
        ...
        #region dicey-comparisons
        internal bool greatrThan(Vector2i v) {
            throw new NotImplementedException();
        }

        internal bool lessThanOrEqualTo(Vector2i v) {
            throw new NotImplementedException();
        }

        internal bool lessThan(Vector2i v) {
            throw new NotImplementedException();
        }
        #endregion
        #region unity-conversion
        public static implicit operator Vector2(Vector2i v) { return new Vector2(v.x, v.y); }
        public static implicit operator Vector3(Vector2i v) { return new Vector3(v.x, v.y, 0f); }
        public static implicit operator Vector2i(Vector2 v) { return new Vector2i((int)v.x, (int)v.y); }
        #endregion
