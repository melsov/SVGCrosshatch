...
namespace g3
{
    public struct Vector3d : IComparable<Vector3d>, IEquatable<Vector3d>
    {
        ...
        public Vector3d Abs {
            get { return new Vector3d(System.Math.Abs(x), System.Math.Abs(y), System.Math.Abs(z)); }
        }
		...
		public bool IsNormalized {
			get { return System.Math.Abs( (x * x + y * y + z * z) - 1) < MathUtil.ZeroTolerance; }
		}
        ...
        public void Round(int nDecimals) {
            ...
            z = System.Math.Round(z, nDecimals);
        }
        ...
        public bool EpsilonEqual(Vector3d v2, double epsilon) {
            return System.Math.Abs(x - v2.x) <= epsilon && 
                   ...
                   System.Math.Abs(z - v2.z) <= epsilon;
        }
        ...
        {
            if (numInputs == 1) {
                if (System.Math.Abs(v0[0]) > System.Math.Abs(v0[1])) {
